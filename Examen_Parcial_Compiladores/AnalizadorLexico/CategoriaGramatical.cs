...
namespace Examen_Parcial_Compiladores.AnalizadorLexico
{
    ...
    {
        PALABRA_RESERVADA_IF, PALABRA_RESERVADA_CLASS,DEFECTO, NO_DEFINIDA,LETRA_A, LETRA_B, LETRA_C, LETRA_D, LETRA_E, LETRA_F, LETRA_G, LETRA_H, LETRA_I, LETRA_J, LETRA_K, LETRA_L, LETRA_M, LETRA_N, LETRA_O, LETRA_P,
        ...
        SUPERINDICE_A, SUPERINDICE_0, VERGULILLA, COMILLA_ABRE, COMILLA_CIERRA, ESPACIO, COMILLA_SIMPLE, FIN_ARCHIVO, FIN_LINEA, SIGNO_ESPACIO
    }
}
